...
public class Pillager extends Enemy implements Damageable {
    ...
    public void render(SpriteBatch pillagerBatch) {
        ...
        int pillagerWidth = currentFrame.getRegionWidth();
        int pillagerHeight = currentFrame.getRegionHeight();

        blinking(pillagerBatch);
        pillagerBatch.draw(currentFrame, position.x - pillagerWidth / 2, position.y - pillagerHeight / 2);
    }
